...
{ /* Scene object main properties (serialized): */
	...
	sim_objectspecialproperty_detectable_ultrasonic | sim_objectspecialproperty_detectable_infrared |
	sim_objectspecialproperty_detectable_laser | sim_objectspecialproperty_detectable_inductive |
...
enum
{ /* type of arguments (input and output) for custom script commands */
...
enum
{ /* OpenGl-based custom UI menu attributes: */
	sim_ui_menu_title = 1,
...
enum
{ /* OpenGl-based custom UI properties. Values are serialized. */
...
{ /* Simulation status */
	...
	/* reserved                                 =sim_simulation_advancing|0x02, */
					...
					sim_simulation_advancing | 0x03,     /* Last simulation pass before pause (1x) */
	sim_simulation_advancing_firstafterpause =
	sim_simulation_advancing | 0x04,     /* First simulation pass after pause (1x) */
	sim_simulation_advancing_abouttostop =
	sim_simulation_advancing | 0x05,     /* "Trying to stop" simulation pass (>=1x) */
...
enum
{ /* Script execution order, is serialized */
...
enum
{ /* Reflexxes Motion Library flags */
...
enum
{ /* prox. sensor or mill volume types */
